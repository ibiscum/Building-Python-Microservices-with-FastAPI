...
from library_mgt.models.request.library import (
    BookIssuanceReq,
    BookRequestReq,
    BookReturnReq,
)
...
def request_book(request: BookRequestReq):
    ...
    if result:
        ...
        return JSONResponse(
            content={"message": "book request not successful"}, status_code=500
        )
...
def return_issued_book(returning: BookReturnReq):
    ...
    result = approval_service.return_issued_book(
