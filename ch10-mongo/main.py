...
from api import (
    survey_graphene_login,
    survey_graphene_profile,
    survey_neo4j,
    survey_workflow,
)
...
app.mount(
    "/ch10/graphql/login",
    GraphQLApp(survey_graphene_login.schema, on_get=make_playground_handler()),
)
app.mount(
    "/ch10/graphql/profile",
    GraphQLApp(survey_graphene_profile.schema, on_get=make_playground_handler()),
)
