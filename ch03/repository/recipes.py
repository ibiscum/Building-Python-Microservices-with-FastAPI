...
class RecipeRepository:
    def __init__(self):
        ...
        ingrA8 = Ingredient(
            measure="cup", qty=0.5, name="whipped cream cheese", id=uuid1()
        )
        ...
        recipeA = Recipe(
            ...
            name="Crustless quiche bites with \
            asparagus and oven-dried tomatoes",
            id=uuid1(),
        )
        ...
        ingrC1 = Ingredient(
            measure="pounds", qty=2.25, name="sweet yellow onions", id=uuid1()
        )
        ...
        ingrC5 = Ingredient(
            measure="cup", qty=4, name="low-sodium chicken brothlarge eggs", id=uuid1()
        )
