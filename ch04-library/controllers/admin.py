...
def delete_book(book_id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "book deletion successful"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "book deletion not successful"}, status_code=500
        )
...
def update_book_details(book_id: int, book_details: BookDetails):
    ...
    if result:
        ...
        return JSONResponse(
            content={"message": "book details update error"}, status_code=500
        )
