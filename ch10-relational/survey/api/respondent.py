...
async def add_respondent(req: RespondentReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert respondent problem encountered"},
            status_code=500,
        )
...
async def update_respondent(id: int, req: RespondentReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update respondent problem encountered"},
            status_code=500,
        )
...
async def delete_respondent(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete respondent record successfully"},
            status_code=201,
        )
    else:
        return JSONResponse(
            content={"message": "delete respondent problem encountered"},
            status_code=500,
        )
