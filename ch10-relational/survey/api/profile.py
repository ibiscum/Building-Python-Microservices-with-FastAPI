...
async def add_profile(req: ProfileReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert profile problem encountered"}, status_code=500
        )
...
async def update_profile(id: int, req: ProfileReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update profile problem encountered"}, status_code=500
        )
...
async def delete_profile(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete profile record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete profile problem encountered"}, status_code=500
        )
