...
async def add_login(req: LoginReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert login problem encountered"}, status_code=500
        )
...
async def update_password(username: str, new_password: str):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "updated login record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "update login problem encountered"}, status_code=500
        )
...
async def delete_login(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete login record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete login problem encountered"}, status_code=500
        )
