...
async def add_choice(req: ChoicesReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert choice problem encountered"}, status_code=500
        )
...
async def update_choice(id: int, req: ChoicesReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update choice problem encountered"}, status_code=500
        )
...
async def delete_choice(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete choice record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete choice problem encountered"}, status_code=500
        )
