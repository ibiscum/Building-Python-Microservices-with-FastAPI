...
async def add_occupation(req: OccupationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert occupation problem encountered"},
            status_code=500,
        )
...
async def update_occupation(id: int, req: OccupationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update occupation problem encountered"},
            status_code=500,
        )
...
async def delete_occupation(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete occupation record successfully"},
            status_code=201,
        )
    else:
        return JSONResponse(
            content={"message": "delete occupation problem encountered"},
            status_code=500,
        )
