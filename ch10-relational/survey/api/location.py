...
async def add_location(req: LocationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert location problem encountered"}, status_code=500
        )
...
async def update_location(id: int, req: LocationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update location problem encountered"}, status_code=500
        )
...
async def delete_location(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete location record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete location problem encountered"}, status_code=500
        )
