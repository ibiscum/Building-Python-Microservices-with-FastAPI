...
async def add_education(req: EducationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert education problem encountered"}, status_code=500
        )
...
async def update_education(id: int, req: EducationReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update education problem encountered"}, status_code=500
        )
...
async def delete_education(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete education record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete education problem encountered"}, status_code=500
        )
