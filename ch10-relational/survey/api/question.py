...
async def add_question(req: QuestionReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert question problem encountered"}, status_code=500
        )
...
async def update_question(id: int, req: QuestionReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update question problem encountered"}, status_code=500
        )
...
async def delete_question(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete question record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
