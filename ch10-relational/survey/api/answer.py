...
async def add_answer(req: AnswersReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert answer problem encountered"}, status_code=500
        )
...
async def update_answer(id: int, req: AnswersReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update answer problem encountered"}, status_code=500
        )
...
async def delete_answer(id: int):
    ...
    if result == True:
        return JSONResponse(
            content={"message": "delete answer record successfully"}, status_code=201
        )
    else:
        return JSONResponse(
            content={"message": "delete answer problem encountered"}, status_code=500
        )
