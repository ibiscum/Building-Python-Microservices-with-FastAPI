...
async def add_cart_item(req: CartReq):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "insert cart unsuccessful"}, status_code=500
        )
...
async def update_item_qty(id: int, qty: int):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "update item qty unsuccessful"}, status_code=500
        )
...
async def add_item_discount(book_id: int, discount: float):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "add item discount unsuccessful"}, status_code=500
        )
...
async def remove_cart_item(id: int):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "delete item unsuccessful"}, status_code=500
        )
