...
def create_reference(req: ReferenceReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert reference unsuccessful"}, status_code=500
        )
...
def update_reference(id: int, req: ReferenceReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update reference unsuccessful"}, status_code=500
        )
...
def remove_reference(id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "delete reference unsuccessful"}, status_code=500
        )
