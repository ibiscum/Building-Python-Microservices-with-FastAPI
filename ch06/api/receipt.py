...
async def add_receipt(req: ReceiptReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert receipt unsuccessful"}, status_code=500
        )
...
async def add_order(id: int, order_id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "add final order unsuccessful"}, status_code=500
        )
...
async def remove_order(id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "delete final order unsuccessful"}, status_code=500
        )
...
async def update_receipt(id: int, req: ReceiptReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update receipt unsuccessful"}, status_code=500
        )
...
async def remove_receipt(id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "delete receipt unsuccessful"}, status_code=500
        )
