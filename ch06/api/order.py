...
async def add_order(req: OrderReq):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "insert order unsuccessful"}, status_code=500
        )
...
async def add_order_item(id: int, cart_id: int):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "add order item unsuccessful"}, status_code=500
        )
...
async def remove_order_item(id: int, cart_id: int):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "delete order item unsuccessful"}, status_code=500
        )
...
async def update_order(id: int, req: OrderReq):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "update order unsuccessful"}, status_code=500
        )
...
async def remove_order(id: int):
    ...
    if result is True:
        ...
        return JSONResponse(
            content={"message": "delete order unsuccessful"}, status_code=500
        )
