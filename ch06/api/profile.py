...
def create_profile(login_id: int, req: UserProfileReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "insert profile unsuccessful"}, status_code=500
        )
...
def add_book_sale(login_id, req: BookForSaleReq):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "update profile unsuccessful"}, status_code=500
        )
...
def delete_book_sale(login_id: int, book_id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "delete booksale unsuccessful"}, status_code=500
        )
...
def block_delinquent(login_id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "block delinquent unsuccessful"}, status_code=500
        )
...
def remove_profile(login_id: int):
    ...
    if result == True:
        ...
        return JSONResponse(
            content={"message": "delete profile unsuccessful"}, status_code=500
        )
